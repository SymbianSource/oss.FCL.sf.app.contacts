...
NONSHARABLE_CLASS(CBCTestSpeedDial) : public CScriptBase
    ...
    private:
        ...
        */
        ...
        virtual TInt TestDialogsNewLL( CStifItemParser& aItem );
        virtual TInt TestShowRemoveL( CStifItemParser& aItem );
        virtual TInt TestDialogsCancelL( CStifItemParser& aItem );
