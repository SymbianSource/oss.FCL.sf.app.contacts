...
#ifndef __CREATORDEFINES2_H__
#define __CREATORDEFINES2_H__

#include <e32def.h>
    
// server name
_LIT( KCreatorServerName,                      "!creatorserver2" );
_LIT( KCreatorServerLib,                       "creatorserver2" );
_LIT( KCreatorServerExe,                       "creatorserver2.exe");
