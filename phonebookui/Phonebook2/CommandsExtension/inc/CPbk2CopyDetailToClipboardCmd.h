...
#ifndef CPBK2COPYDETAILTOCLIPBOARDCMD_H
#define CPBK2COPYDETAILTOCLIPBOARDCMD_H
...
NONSHARABLE_CLASS(CPbk2CopyDetailToClipboardCmd) :
        public CBase,
        public MPbk2Command,
        private MVPbkSingleContactOperationObserver
    {
    public: 
        static CPbk2CopyDetailToClipboardCmd* NewL(MPbk2ContactUiControl& aUiControl);
        
        ~CPbk2CopyDetailToClipboardCmd();
...
#endif // CPBK2COPYDETAILTOCLIPBOARDCMD_H   
// End of file
