...
* Contributors:
*
* Description:  Phonebook 2 names list startup state.
*
*/


#ifndef CPBK2NAMESLISTSTARTUPSTATE_H
#define CPBK2NAMESLISTSTARTUPSTATE_H
 ...
 */
NONSHARABLE_CLASS(CPbk2NamesListStartupState) : public CBase,
    ...
    public:  // Constructors and destructor
         ...
         */
        static CPbk2NamesListStartupState* NewLC(
...
#endif // CPBK2NAMESLISTSTARTUPSTATE_H
