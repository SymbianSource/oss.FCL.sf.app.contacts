...
# ----------------------------------------------------------------------------
# Inspect the SECURITY_FLAG to find out target directories for bitmaps.
# ----------------------------------------------------------------------------
ifeq ($(SECURITY_FLAG), off)  
  AIF_TARGETDIR=$(ZDIR)\SYSTEM\APPS\Phonebook
  MIF_TARGETDIR=$(ZDIR)\SYSTEM\Data
else  
...
AIF_ICONFILE=$(AIF_TARGETDIR)\phonebook_aif.mif
MIF_ICONFILE=$(MIF_TARGETDIR)\phonebook.mif
MIF_HEADERFILE=$(HEADERDIR)\phonebook.mbg
