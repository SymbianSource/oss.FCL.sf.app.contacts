...
class MobCntModelData : public QSharedData
{
public:
    MobCntModelData( const QContactFilter& contactFilter = QContactFilter(),
                     ...
                     bool showMyCard = true) :
                      ...
                      { }
    ~MobCntModelData() { if (ownedContactManager) {delete m_contactManager;}}
